# Generated by Django 3.0.2 on 2020-10-19 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volunteer_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='microdonate.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Donate',
            fields=[
                ...
                ('donate_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='microdonate.Profile')),
            ],
        ),
    ]
